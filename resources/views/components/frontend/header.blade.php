<nav class="relative px-4 py-4 flex justify-between items-center bg-indigo-300">
    ...
    <ul
        ...
        <li>
            <a class="text-sm text-white hover:text-gray-500" href="{{ route('home') }}">
                Home
            </a>
        </li>
        @if ($about)
            ...
            <li>
                <a class="text-sm text-white hover:text-gray-500"
                    href="{{ route('frontend.dynamic.page', $about->slug) }}">
                    {{ $about->title }}
                </a>
            </li>
        @endif
        @if ($services)
            ...
            <li>
                <a class="text-sm text-white hover:text-gray-500"
                    href="{{ route('frontend.dynamic.page', $services->slug) }}">
                    {{ $services->title }}
                </a>
            </li>
        @endif
        ...
        @if ($contact)
            ...
            <li>
                <a class="text-sm text-white hover:text-gray-500"
                    href="{{ route('frontend.dynamic.page', $contact->slug) }}">
                    {{ $contact->title }}
                </a>
            </li>
        @endif
