    ...
    <div class="row">
        <div class="col-6 mb-3">
            <div class="form-group">
                <label for="title" class="form-label">Page Type <span class="text-danger">*</span> : </label>

                <Select class="custom-select" name="slug" required>
                    <option value="">-- Select page type --</option>
                    <option value="about" {{ $page->slug == 'about' ? 'selected' : '' }}>
                        About page
                    </option>
                    <option value="contact" {{ $page->slug == 'contact' ? 'selected' : '' }}>
                        Contact page
                    </option>
                    <option value="services" {{ $page->slug == 'services' ? 'selected' : '' }}>
                        Services page
                    </option>
                </Select>
            </div>
        ...
        <div class="col-6 mb-3">
            <div class="form-group">
                ...
                <input type="text" class="form-control" autocomplete="off" name="title" placeholder="Enter title"
